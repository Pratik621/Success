      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="bg-[#1E293B] rounded-2xl border border-white/5 shadow-2xl p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required value={form.email}
                  ...
                  className="input-dark pl-10" placeholder="company@email.com" />
              </div>
            </div>
            <div>
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? (
                ...
                <span className="flex items-center gap-2">Sign In <LuArrowRight size={16} /></span>
              )}
            </button>
          </form>
          <div className="mt-6 pt-5 border-t border-white/5 text-center space-y-3">
            ...
            <Link to="/admin/login" className="text-xs text-slate-600 hover:text-slate-400 transition block">
              Admin Login →
            </Link>
